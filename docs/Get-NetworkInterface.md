...
online version: https://github.com/swisscom/PowerSponse/blob/master/docs/Get-NetworkInterface.md
schema: 2.0.0
---
...
```
Get-NetworkInterface [[-ComputerName] <String[]>] [[-ComputerList] <String>] [-Method <String>]
 [[-Session] <PSSession[]>] [[-Credential] <PSCredential>] [-OnlineCheck <Boolean>]
 [[-InterfaceIndex] <String>] [[-InterfaceDescription] <String>] [-OnlyIndex] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```
...
### -OnlyIndex
Return only the index of the interface.
