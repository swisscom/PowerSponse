...
online version: https://github.com/swisscom/PowerSponse/blob/master/docs/Disable-RemoteRegistry.md
schema: 2.0.0
---
...
```
Disable-RemoteRegistry [[-ComputerName] <String[]>] [-ComputerList <String>] [-Method <String>]
 [-BinPath <String>] [-Session <PSSession[]>] [-Credential <PSCredential>] [-OnlineCheck] [-WhatIf] [-Confirm]
 [<CommonParameters>]
```

## DESCRIPTION
Disable the RemoteRegistry service. The service is needed for PsExec.
