...
```
Disable-Service [-ComputerName <String[]>] [-ComputerList <String>] [-Method <String>] [-BinPath <String>]
 [-Session <PSSession[]>] [-Credential <PSCredential>] [-OnlineCheck <Boolean>] [-NoRemoteRegistry]
 [-Name <String>] [-WhatIf] [-Confirm] [<CommonParameters>]
```

## DESCRIPTION
The **Disable-Service** cmdlet lets you disable a service. You can also use
regex for the mandatory parameter "Name".
