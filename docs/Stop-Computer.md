...
online version: https://github.com/swisscom/PowerSponse/blob/master/docs/Stop-Computer.md
schema: 2.0.0
---
...
```
Stop-Computer [[-ComputerName] <String[]>] [[-ComputerList] <String>] [[-Method] <String>]
